...
- (NSString*) capturePhoto
{
    ...
    NSString *filename = [NSString stringWithFormat:@"test%@.jpg", guid];
    ...
    [[[self stillImageOutput] connectionWithMediaType:AVMediaTypeVideo] setVideoOrientation:[_videoConnection videoOrientation]];
